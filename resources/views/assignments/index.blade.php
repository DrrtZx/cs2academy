...
<div class="assign-wrap">
  ...
  {{-- Active Coaching Status Banner (hanya muncul saat ada sesi yang sedang aktif) --}}
  @if($activeSessions->count() > 0)
    <div style="background:linear-gradient(135deg, rgba(0,212,170,0.12), rgba(124,111,224,0.12));border:1px solid rgba(0,212,170,0.3);border-radius:18px;padding:1.25rem 1.5rem;margin-bottom:1.75rem;display:flex;align-items:center;gap:14px;box-shadow:0 8px 24px rgba(0,0,0,0.2);">
