...
<div style="max-width:480px;margin:0 auto;text-align:center;padding:5rem 2rem;">
  ...
  <p style="color:var(--text2);line-height:1.75;margin-bottom:2rem;font-size:0.9rem;">
    Terima kasih! Coach CS2 kamu akan segera ditugaskan dalam
    <strong style="color:var(--green);">5 menit</strong>.
    Sekarang kamu bisa mengirimkan pertanyaan atau tugas untuk di-review oleh admin/coach.
  </p>
  ...
  <a href="{{ route('assignments.index') }}" style="display:block;width:100%;padding:13px;border-radius:12px;font-size:0.95rem;font-weight:700;background:transparent;color:var(--text);border:1px solid var(--border);text-align:center;">📝 Kirim Tugas / Pertanyaan</a>
</div>
@endsection
